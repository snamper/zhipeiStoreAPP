      ...
      <div class="eu-adExplainBox">
        <dl>
          ...
          <dd>
            ...
            <p>为更好的服务智配Store VIP会员，确保付费会员的查询响应度，基于APP运营效果并提高付费会员满意度，针对非付费用户在智配Store查询量非常大的时候，可能会存在拥挤或者需要多次查询才能显示结果。感谢付费用户对我们智配Store的支持，非付费用户为了更方便更及时的服务您的客户，建议您避开高峰时间段或者选择购买VIP会员服务。</p>
